...
#define SI_USE_OUTPUT_PRESCALAR 0
#define SI_SIGNAL_CAPTURE_FILTER 1
#define SI_SIGNAL_EEPROM_INPUT_PRESCALER (139 - 1)
...
void InitializeTimersSI(void)
{
    ...
    htim3.Init.Prescaler = 135 - 1; // 2 ticks per 1us; 540 / 2 = 270; 270 / 2 = 135; 135 mhz; 1us per 1 mhz; 1
#else
